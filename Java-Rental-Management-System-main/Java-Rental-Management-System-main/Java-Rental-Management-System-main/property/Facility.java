...
public class Facility {
    ...
    public void setFacility(ArrayList<String> facilities){ //set facility from user input
        ...
        for(String facility: facilities){
            if (facility.equals("Swimming Pool")) {
				this.swimmingPool = true;
			}
            if (facility.equals("Parking")) {
				this.parking = true;
			}
            if (facility.equals("Wifi")) {
				this.wifi = true;
			}
            if (facility.equals("Air Conditional")) {
				this.airCon = true;
			}
            if (facility.equals("Tv")) {
				this.tv = true;
			}
            if (facility.equals("Fridge")) {
				this.fridge = true;
			}
            if (facility.equals("Washing Machine")) {
				this.washingMachine = true;
			}
            if (facility.equals("Gym Room")) {
				this.gymRoom = true;
			}
            if (facility.equals("Water Heater")) {
				this.waterHeater = true;
			}
            if (facility.equals("Stove")) {
				this.gas = true;
			}
        }
    }
