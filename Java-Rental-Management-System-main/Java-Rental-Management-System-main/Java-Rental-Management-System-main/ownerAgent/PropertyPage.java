...
public class PropertyPage extends Frame{
    ...
    private ArrayList<JCheckBox> facilityCB = new ArrayList<>();
    ...
    PropertyPage(){
        ...
        setComponent(priceLabel, "Rental Price:    Rs", priceTF, "", priceSep);
        ...
        saveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
                ...
                ArrayList<String> selectedFacility = new ArrayList<>();
