...
public class Admin extends Account{
    ...
    public void approveRequest(Request request){ //approve request, create a new account, send email
        try{
            ...
            account.setRole((int) request.getRole());
            ...
            if(account.createAccount()){
                ...
                sendEmail("www.crushervb2003@gmail.com","ooadcyberent",account.getEmail(),"Cyberent Application","Welcome to Cyberent!\n"+"\nCongratulations! Your registration has been approved!\n"+
    ...
    public void declineRequest(int id, String email){ //decline request, send email
        try{
            ...
            System.out.println("Sending Email....");
            sendEmail("www.crushervb2003@gmail.com","ooadcyberent",email,
    ...
    public void addAdmin(String name, String email,String phone,String password){  //add new admin, invoke function to save into database, and send email
        try{

            Admin newAdmin = new Admin();
            newAdmin.setName(name);
            newAdmin.setEmail(email);
            newAdmin.setPhone(Long.parseLong(phone));
            ...
            if(newAdmin.createAccount()){
                sendEmail("www.crushervb2003@gmail.com","ooadcyberent",newAdmin.getEmail(),"Cyberent Admin","Welcome!\n"+"\nYou are now an admin of Cyberent.\n"+
    ...
    public ArrayList<ArrayList<Object>> getAdminList(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                adminItem.add(rs.getLong("admin_phone"));
